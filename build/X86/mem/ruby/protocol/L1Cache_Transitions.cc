                                        ...
                                        Addr addr)
{
  ...
  case HASH_FUN(L1Cache_State_IS, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_IM, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_IS_I, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_M_I, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_SM, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_SINK_WB_ACK, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_PF_IS, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_PF_IS_I, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_PF_IM, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_PF_SM, L1Cache_Event_PF_L1_Replacement):
    z_stallAndWaitOptionalQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;

  case HASH_FUN(L1Cache_State_NP, L1Cache_Event_L1_Replacement):
  case HASH_FUN(L1Cache_State_NP, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_I, L1Cache_Event_L1_Replacement):
  case HASH_FUN(L1Cache_State_I, L1Cache_Event_PF_L1_Replacement):
  ...
  case HASH_FUN(L1Cache_State_PF_IS_I, L1Cache_Event_PF_Load):
  case HASH_FUN(L1Cache_State_PF_IS_I, L1Cache_Event_PF_Store):
  case HASH_FUN(L1Cache_State_PF_IS_I, L1Cache_Event_PF_Ifetch):
  ...
  case HASH_FUN(L1Cache_State_PF_IM, L1Cache_Event_PF_Ifetch):
    pq_popPrefetchQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
  ...
  case HASH_FUN(L1Cache_State_I, L1Cache_Event_Load):
    ...
    po_observeMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_I, L1Cache_Event_PF_Load):
    next_state = L1Cache_State_PF_IS; m_curTransitionNextState = next_state;
    if (!(*m_TBEs_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    if (!(*m_requestFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    oo_allocateL1DCacheBlock(m_tbe_ptr, m_cache_entry_ptr, addr);
    i_allocateTBE(m_tbe_ptr, m_cache_entry_ptr, addr);
    pa_issuePfGETS(m_tbe_ptr, m_cache_entry_ptr, addr);
    pq_popPrefetchQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
  ...
  case HASH_FUN(L1Cache_State_PF_IS, L1Cache_Event_Ifetch):
    next_state = L1Cache_State_IS; m_curTransitionNextState = next_state;
    uu_profileDataMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
    ppm_observePfMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
    k_popMandatoryQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;

  case HASH_FUN(L1Cache_State_PF_IS_I, L1Cache_Event_Load):
    next_state = L1Cache_State_IS_I; m_curTransitionNextState = next_state;
    uu_profileDataMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
    ppm_observePfMiss(m_tbe_ptr, m_cache_entry_ptr, addr);
    k_popMandatoryQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;

  case HASH_FUN(L1Cache_State_PF_IS_I, L1Cache_Event_Ifetch):
    next_state = L1Cache_State_IS_I; m_curTransitionNextState = next_state;
  ...
  case HASH_FUN(L1Cache_State_I, L1Cache_Event_PF_Ifetch):
    ...
    pp_allocateL1ICacheBlock(m_tbe_ptr, m_cache_entry_ptr, addr);
    i_allocateTBE(m_tbe_ptr, m_cache_entry_ptr, addr);
    pai_issuePfGETINSTR(m_tbe_ptr, m_cache_entry_ptr, addr);
    pq_popPrefetchQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
  ...
  case HASH_FUN(L1Cache_State_I, L1Cache_Event_PF_Store):
    next_state = L1Cache_State_PF_IM; m_curTransitionNextState = next_state;
    if (!(*m_TBEs_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    if (!(*m_requestFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    oo_allocateL1DCacheBlock(m_tbe_ptr, m_cache_entry_ptr, addr);
    i_allocateTBE(m_tbe_ptr, m_cache_entry_ptr, addr);
    pb_issuePfGETX(m_tbe_ptr, m_cache_entry_ptr, addr);
    pq_popPrefetchQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
  ...
  case HASH_FUN(L1Cache_State_M, L1Cache_Event_Load):
    ...
    po_observeHit(m_tbe_ptr, m_cache_entry_ptr, addr);
    k_popMandatoryQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
  ...
  case HASH_FUN(L1Cache_State_S, L1Cache_Event_PF_L1_Replacement):
  ...
  case HASH_FUN(L1Cache_State_E, L1Cache_Event_PF_L1_Replacement):
  case HASH_FUN(L1Cache_State_M, L1Cache_Event_L1_Replacement):
  case HASH_FUN(L1Cache_State_M, L1Cache_Event_PF_L1_Replacement):
    next_state = L1Cache_State_M_I; m_curTransitionNextState = next_state;
    if (!(*m_TBEs_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    if (!(*m_requestFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
  ...
  case HASH_FUN(L1Cache_State_M_I, L1Cache_Event_Inv):
    next_state = L1Cache_State_SINK_WB_ACK; m_curTransitionNextState = next_state;
    if (!(*m_responseFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
  ...
  case HASH_FUN(L1Cache_State_PF_IS, L1Cache_Event_Inv):
    next_state = L1Cache_State_PF_IS_I; m_curTransitionNextState = next_state;
    if (!(*m_responseFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    fi_sendInvAck(m_tbe_ptr, m_cache_entry_ptr, addr);
    l_popRequestQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_PF_IS, L1Cache_Event_Data_all_Acks):
    ...
    u_writeDataToL1Cache(m_tbe_ptr, m_cache_entry_ptr, addr);
    s_deallocateTBE(m_tbe_ptr, m_cache_entry_ptr, addr);
    mp_markPrefetched(m_tbe_ptr, m_cache_entry_ptr, addr);
    o_popIncomingResponseQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    kd_wakeUpDependents(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
  ...
  case HASH_FUN(L1Cache_State_IS, L1Cache_Event_Data_Exclusive):
    next_state = L1Cache_State_E; m_curTransitionNextState = next_state;
    if (!(*m_unblockFromL1Cache_ptr).areNSlotsAvailable(1, clockEdge()))
        return TransitionResult_ResourceStall;
    u_writeDataToL1Cache(m_tbe_ptr, m_cache_entry_ptr, addr);
    hx_load_hit(m_tbe_ptr, m_cache_entry_ptr, addr);
  ...
  case HASH_FUN(L1Cache_State_PF_IM, L1Cache_Event_Data):
    next_state = L1Cache_State_PF_SM; m_curTransitionNextState = next_state;
    u_writeDataToL1Cache(m_tbe_ptr, m_cache_entry_ptr, addr);
    q_updateAckCount(m_tbe_ptr, m_cache_entry_ptr, addr);
    o_popIncomingResponseQueue(m_tbe_ptr, m_cache_entry_ptr, addr);
    return TransitionResult_Valid;
