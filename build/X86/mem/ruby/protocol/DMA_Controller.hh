...
private:
    ...
    DMA_Event m_curTransitionEvent;
    DMA_State m_curTransitionNextState;

    DMA_Event curTransitionEvent() { return m_curTransitionEvent; }
    DMA_State curTransitionNextState() { return m_curTransitionNextState; }
