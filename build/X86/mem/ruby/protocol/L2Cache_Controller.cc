...
std::vector<statistics::Vector *>  L2Cache_Controller::eventVec;
std::vector<std::vector<statistics::Vector *> >  L2Cache_Controller::transVec;

// for adding information to the protocol debug trace
std::stringstream L2Cache_transitionComment;
...
DMASequencer*
L2Cache_Controller::getDMASequencer() const
{
    return NULL;
}
...
L2Cache_Controller::regStats()
{
    ...
    if (m_version == 0) {
        ...
        for (L2Cache_Event event = L2Cache_Event_FIRST;
            ...
            std::string stat_name =
                "L2Cache_Controller." + L2Cache_Event_to_string(event);
            statistics::Vector *t =
        ...
        for (L2Cache_State state = L2Cache_State_FIRST;
            ...
            for (L2Cache_Event event = L2Cache_Event_FIRST;
                 event < L2Cache_Event_NUM; ++event) {
                std::string stat_name = "L2Cache_Controller." +
    ...
    for (L2Cache_Event event = L2Cache_Event_FIRST;
                 event < L2Cache_Event_NUM; ++event) {
        std::string stat_name =
            "outTransLatHist." + L2Cache_Event_to_string(event);
    ...
    for (L2Cache_Event event = L2Cache_Event_FIRST;
        ...
        for (L2Cache_State initial_state = L2Cache_State_FIRST;
             initial_state < L2Cache_State_NUM; ++initial_state) {
            stats.inTransLatHist.back().emplace_back();
            for (L2Cache_State final_state = L2Cache_State_FIRST;
                 final_state < L2Cache_State_NUM; ++final_state) {
                std::string stat_name = "inTransLatHist." +
                    L2Cache_Event_to_string(event) + "." +
                    L2Cache_State_to_string(initial_state) + "." +
                    L2Cache_State_to_string(final_state);
                statistics::Histogram* t =
                    new statistics::Histogram(&stats, stat_name.c_str());
...
MessageBuffer*
L2Cache_Controller::getMemReqQueue() const
{
    return NULL;
}

MessageBuffer*
L2Cache_Controller::getMemRespQueue() const
{
    return NULL;
}

void
L2Cache_Controller::print(std::ostream& out) const
{
    ...
    }
{
    ...
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:427: %s.\n", "assert failure");
...
L2Cache_Controller::c_exclusiveReplacement(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:439: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:476: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:495: %s.\n", "assert failure");
...
L2Cache_Controller::ex_sendExclusiveDataToGetSRequestors(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:541: %s.\n", "assert failure");
...
;
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:544: %s.\n", "assert failure");
...
L2Cache_Controller::ee_sendDataToGetXRequestor(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_tbe_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:556: %s.\n", "assert failure");
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:557: %s.\n", "assert failure");
    ...
    DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:562: %s\n", (*out_msg).m_Destination);
    (*out_msg).m_DataBlk = (*m_cache_entry_ptr).m_DataBlk;
    DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:564: Address: %#x, Destination: %s, DataBlock: %s\n", (*out_msg).m_addr, (*out_msg).m_Destination, (*out_msg).m_DataBlk);
    (*out_msg).m_MessageSize = MessageSizeType_Response_Data;
    ((*m_responseFromL2Cache_ptr)).enqueue(out_msg, clockEdge(), cyclesToTicks(Cycles(m_to_l1_latency)));
}
...
L2Cache_Controller::f_sendInvToSharers(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:572: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:584: %s.\n", "assert failure");
...
L2Cache_Controller::i_allocateTBE(L2Cache_TBE*& m_tbe_ptr, L2Cache_Entry*& m_cache_entry_ptr, Addr addr)
{
    ...
    try {
       #ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:611: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:642: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:652: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:662: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:672: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:680: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_tbe_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:687: %s.\n", "assert failure");
    ...
    }
{
    ...
    #ifndef NDEBUG
    if (!((m_cache_entry_ptr != NULL))) {
        panic("Runtime Error at MESI_Two_Level-L2cache.sm:722: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:744: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:766: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:773: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((m_cache_entry_ptr != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:782: %s.\n", "assert failure");
...
#ifndef NDEBUG
if (!((param_cache_entry != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:189: %s.\n", "assert failure");

}
#endif
;
DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:190: machineID: %s, requestor: %s, address: %#x\n", m_machineID, param_requestor, param_addr);
                            ...
                            if ((param_type == CoherenceRequestType_UPGRADE)) {
                                    if (((param_cache_entry != NULL) && (((*param_cache_entry).m_Sharers).isElement(param_requestor)))) {
                                        ...
                                        if ((param_type == CoherenceRequestType_PUTX)) {
                                                ...
                                                DPRINTF(RubySlicc, "MESI_Two_Level-L2cache.sm:283: address: %#x, Request Type: %s\n", param_addr, param_type);
                                                panic("Runtime Error at MESI_Two_Level-L2cache.sm:284: %s.\n", ("Invalid L1 forwarded request type"));
                                                ;
                                            }
                                        }
                                    }
...
#ifndef NDEBUG
if (!((param_cache_entry != NULL))) {
    panic("Runtime Error at MESI_Two_Level-L2cache.sm:293: %s.\n", "assert failure");
...
bool
L2Cache_Controller::functionalReadBuffers(PacketPtr& pkt)
{
if (m_DirRequestFromL2Cache_ptr->functionalRead(pkt)) return true;
if (m_L1RequestFromL2Cache_ptr->functionalRead(pkt)) return true;
if (m_responseFromL2Cache_ptr->functionalRead(pkt)) return true;
if (m_unblockToL2Cache_ptr->functionalRead(pkt)) return true;
if (m_L1RequestToL2Cache_ptr->functionalRead(pkt)) return true;
if (m_responseToL2Cache_ptr->functionalRead(pkt)) return true;
    return false;
}

bool
L2Cache_Controller::functionalReadBuffers(PacketPtr& pkt, WriteMask &mask)
{
    bool read = false;
if (m_DirRequestFromL2Cache_ptr->functionalRead(pkt, mask)) read = true;
if (m_L1RequestFromL2Cache_ptr->functionalRead(pkt, mask)) read = true;
if (m_responseFromL2Cache_ptr->functionalRead(pkt, mask)) read = true;
if (m_unblockToL2Cache_ptr->functionalRead(pkt, mask)) read = true;
if (m_L1RequestToL2Cache_ptr->functionalRead(pkt, mask)) read = true;
if (m_responseToL2Cache_ptr->functionalRead(pkt, mask)) read = true;
    return read;
}
