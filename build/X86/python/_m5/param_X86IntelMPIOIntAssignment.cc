...
{
py::module_ m = m_internal.def_submodule("param_X86IntelMPIOIntAssignment");
    ...
    py::class_<gem5::X86ISA::intelmp::IOIntAssignment, gem5::X86ISA::intelmp::BaseConfigEntry, std::unique_ptr<gem5::X86ISA::intelmp::IOIntAssignment, py::nodelete>>(m, "gem5_COLONS_X86ISA_COLONS_intelmp_COLONS_IOIntAssignment")
        ;
 ...
 */
class DummyX86IntelMPIOIntAssignmentParamsClass
{
  public:
...
class DummyX86IntelMPIOIntAssignmentShunt;
...
class DummyX86IntelMPIOIntAssignmentShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const X86IntelMPIOIntAssignmentParams &>>>
{
  public:
    using Params = X86IntelMPIOIntAssignmentParams;
    static gem5::X86ISA::intelmp::IOIntAssignment *
...
{
  public:
    using Params = DummyX86IntelMPIOIntAssignmentParamsClass;
    static gem5::X86ISA::intelmp::IOIntAssignment *
    create(const Params &p)
    {
        return nullptr;
 ...
 */
[[maybe_unused]] gem5::X86ISA::intelmp::IOIntAssignment *
DummyX86IntelMPIOIntAssignmentShunt<gem5::X86ISA::intelmp::IOIntAssignment>::Params::create() const
{
    return DummyX86IntelMPIOIntAssignmentShunt<gem5::X86ISA::intelmp::IOIntAssignment>::create(*this);
}
