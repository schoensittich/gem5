...
class DummyTimingExprReadIntRegShunt<CxxClass, std::enable_if_t<
    std::is_constructible_v<CxxClass, const TimingExprReadIntRegParams &>>>
{
  public:
 ...
 */
[[maybe_unused]] gem5::TimingExprReadIntReg *
DummyTimingExprReadIntRegShunt<gem5::TimingExprReadIntReg>::Params::create() const
{
    return DummyTimingExprReadIntRegShunt<gem5::TimingExprReadIntReg>::create(*this);
}
