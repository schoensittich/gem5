...
()
    ...
    Directory_TBE(const Addr& local_PhysicalAddress, const Directory_State& local_TBEState, const DataBlock& local_DataBlk, const int& local_Len, const MachineID& local_DmaRequestor)
    {
